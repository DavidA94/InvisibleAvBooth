...
export function ManageStreamsModal({ isOpen, onClose }: ManageStreamsModalProps): ReactNode {
  ...
  const hasNoneStreaming = !isAnyStreaming;
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            {platforms.map(([name, platform]) => (
              <div
                ...
                style={{ display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.375rem 0" }}
              >
                <span
                  style={{
                    width: "0.5rem",
                    height: "0.5rem",
                    borderRadius: "50%",
                    backgroundColor: STATUS_COLORS[platform.state],
                    flexShrink: 0,
                  }}
                />
