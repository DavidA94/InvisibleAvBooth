...
import {
  TEST_ID_USER_LIST, TEST_ID_USER_LIST_ITEM, TEST_ID_ADD_USER_BUTTON,
  TEST_ID_USER_DETAIL_EMPTY, TEST_ID_USER_FORM_USERNAME, TEST_ID_USER_FORM_PASSWORD,
  TEST_ID_USER_FORM_SAVE, TEST_ID_USER_FORM_DELETE, TEST_ID_USER_FORM_ERROR,
  TEST_ID_USER_FORM_ROLE_SELECT, TEST_ID_USER_LIST_DELETE_BUTTON,
